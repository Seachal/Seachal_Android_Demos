...
/**
 * An example animation handler Animates translation, rotation, scale and alpha at the same time using Property
 * Animation APIs.
 */
public class DefaultAnimationHandler extends MenuAnimationHandler {
    ...
    public void animateMenuOpening(Point center) {
        ...
        for (int i = 0; i < menu.getSubActionItems().size(); i++) {
            ...
            animation
                .addListener(new SubActionItemAnimationListener(menu.getSubActionItems().get(i), ActionType.OPENING));
    ...
    public void animateMenuClosing(Point center) {
        ...
        for (int i = 0; i < menu.getSubActionItems().size(); i++) {
            ...
            animation
                .addListener(new SubActionItemAnimationListener(menu.getSubActionItems().get(i), ActionType.CLOSING));
