...
public class SwitchView extends View {
  ...
  protected void onSizeChanged(int w, int h, int oldw, int oldh) {
    ...
    shadowGradient = new RadialGradient(bWidth / 2, bWidth / 2, bWidth / 2, 0xff000000, 0x00000000,
  ...
  protected void onDraw(Canvas canvas) {
    ...
    paint.setColor(isOn ? 0xffd81300 : 0xffe3e3e3);
    ...
    paint.setColor(isOn ? 0xffd81300 : 0xffbfbfbf);
    canvas.drawPath(bPath, paint);
  ...
  /**
   * if set true , the state change to on; if set false, the state change to off <br>
   * <b>change state with animation</b>
   * 
   * @param letItOn
   */
